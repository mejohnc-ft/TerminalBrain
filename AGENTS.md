...
When Terminal Brain may not be running, use `make next`, `make status`, MCP `terminal_brain_next_markdown`, or MCP `terminal_brain_runtime_status` first. These checks do not launch or foreground the app.

...
- Use `make doctor` when setup readiness is unclear; it audits app install freshness, MCP contract, agent config, prompt-prone Apple Notes/Drafts bridges, process state, launchctl, and API reachability without launching the app.

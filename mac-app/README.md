...
- App Shortcuts for Copy Deck, Copy Snapshot, Run Sync, Start Work, and Open Latest Context Pack in Spotlight, Siri, and automation.
- Menu bar extra with current Focus, Ask Current Focus, Build Focus Pack, Open Latest Context Pack, refresh, sync, copy, Mission, and logs.

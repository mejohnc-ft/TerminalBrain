...
echo "3. Use Now opens first and shows one move, why that move matters, Ask, Capture, Delegate, and Close paths."
echo "4. Radar shows a Check Blindspots counter-signal path before action."
echo "5. Blindspots can become tracked ideas through Capture as Idea."
echo "6. Ideas has a direct capture lane and makes the cheap-test loop obvious."
echo "7. Buttons have comfortable hit targets and do not feel sparse or ambiguous."
echo "8. Text does not overlap, truncate badly, or resize the layout at normal and narrow widths."
echo "9. Theme, profile menu, settings, and reduce-glass controls are discoverable."
echo "10. No permissions prompts or focus-stealing relaunch behavior appears during normal viewing."
echo
echo "## Acceptance"
echo

...
require_contains "$work_block_output" '# Terminal Brain Bubble Up' "work block Bubble Up section"
require_contains "$work_block_output" '# Terminal Brain Review Queue' "work block Review Queue section"
...
require_contains "$mcp_work_block_output" '# Terminal Brain Bubble Up' "MCP work block Bubble Up section"
require_contains "$mcp_work_block_output" '# Terminal Brain Review Queue' "MCP work block Review Queue section"

...
evidence "Idea capture" "grep -q 'local-fallback' '$ROOT/mac-app/scripts/idea.zsh' && grep -q '## Cheap Test' '$ROOT/mac-app/scripts/idea.zsh' && grep -q '## Kill Criteria' '$ROOT/mac-app/scripts/idea.zsh' && grep -q 'terminal_brain_capture_idea' '$ROOT/mcp-server/server.mjs'" "make idea and MCP idea capture with cheap-test prompts"

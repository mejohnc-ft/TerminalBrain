...
evidence "Proactive freshness and action cards" "grep -q '^freshness:' '$ROOT/Makefile' && grep -q '^action-cards:' '$ROOT/Makefile' && grep -q '^daily-brief:' '$ROOT/Makefile' && grep -q 'Terminal Brain Freshness' '$ROOT/mac-app/scripts/freshness.zsh' && grep -q 'Terminal Brain Action Cards' '$ROOT/mac-app/scripts/action-cards.zsh' && grep -q 'Terminal Brain Daily Brief' '$ROOT/mac-app/scripts/daily-brief.zsh' && grep -q 'terminal_brain_freshness_markdown' '$ROOT/mcp-server/server.mjs' && grep -q 'terminal_brain_action_cards_markdown' '$ROOT/mcp-server/server.mjs' && grep -q 'terminal_brain_daily_brief_markdown' '$ROOT/mcp-server/server.mjs'" "make freshness/action-cards/daily-brief and MCP equivalents track staleness and rank proactive next actions"

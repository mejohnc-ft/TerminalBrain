...
require_in_file "$ROOT/mac-app/Sources/TerminalBrain/ContentView.swift" 'useNowBubblingPanel' "Use Now native bubbling signal panel"
require_in_file "$ROOT/mac-app/Sources/TerminalBrain/ContentView.swift" 'Bubbling Now' "Use Now native bubbling signal copy"
require_in_file "$ROOT/mac-app/Sources/TerminalBrain/ContentView.swift" 'openBubblingSignal' "Use Now native bubbling signal routing"
...
require_in_file "$ROOT/mac-app/Sources/TerminalBrain/ContentView.swift" 'Open Completion Audit' "command palette can open Completion Audit"
...
require_in_file "$ROOT/mac-app/Sources/TerminalBrain/TerminalBrainApp.swift" 'Copy Completion Audit' "Completion Audit menu bar/menu command"
require_in_file "$ROOT/mac-app/Sources/TerminalBrain/TerminalBrainApp.swift" 'Copy Visual Review Plan' "Visual Review Plan menu bar/menu command"
...
require_in_file "$ROOT/mac-app/Sources/TerminalBrain/BrainStatusModel.swift" 'func copyCompletionAudit' "in-app Completion Audit copy action"
require_in_file "$ROOT/mac-app/Sources/TerminalBrain/BrainStatusModel.swift" 'func copyVisualReviewPlan' "in-app Visual Review Plan copy action"
...
require_in_file "$ROOT/mac-app/Sources/TerminalBrain/AppShortcuts.swift" 'CopyCompletionAuditIntent' "Copy Completion Audit App Shortcut"
require_in_file "$ROOT/mac-app/Sources/TerminalBrain/AppShortcuts.swift" 'CopyVisualReviewPlanIntent' "Copy Visual Review Plan App Shortcut"
...
require_in_file "$ROOT/mac-app/Sources/TerminalBrain/LocalControlServer.swift" '"/completion-audit/markdown"' "Completion Audit API route"
require_in_file "$ROOT/mac-app/Sources/TerminalBrain/LocalControlServer.swift" '"/visual-review-plan/markdown"' "Visual Review Plan API route"
require_in_file "$ROOT/mac-app/Sources/TerminalBrain/LocalControlServer.swift" 'TERMINAL_BRAIN_COMPLETION_AUDIT_SKIP_VERIFY' "Completion Audit native light mode"
...
require_in_file "$ROOT/mac-app/Sources/TerminalBrain/LocalControlServer.swift" '"/what-now/markdown"' "What Now API route"
...
require_in_file "$ROOT/mac-app/scripts/now.zsh" 'make start' "Now starts with Start"
...
require_in_file "$ROOT/mac-app/scripts/what-now.zsh" 'make start' "What Now next value command"
...
require_in_file "$ROOT/Makefile" '^freshness:' "Freshness Make target"
require_in_file "$ROOT/Makefile" '^action-cards:' "Action Cards Make target"
require_in_file "$ROOT/Makefile" '^daily-brief:' "Daily Brief Make target"
require_in_file "$ROOT/Makefile" '^refresh-memory:' "Refresh Memory Make target"
require_in_file "$ROOT/Makefile" '^meeting-records:' "Meeting Records Make target"
require_in_file "$ROOT/mac-app/scripts/freshness.zsh" 'Terminal Brain Freshness' "non-launching freshness registry"
require_in_file "$ROOT/mac-app/scripts/freshness.zsh" 'source-freshness.json' "freshness registry file"
require_in_file "$ROOT/mac-app/scripts/action-cards.zsh" 'Terminal Brain Action Cards' "non-launching proactive action cards"
require_in_file "$ROOT/mac-app/scripts/action-cards.zsh" 'Refresh stale agent-memory synthesis' "action cards stale memory card"
require_in_file "$ROOT/mac-app/scripts/action-cards.zsh" 'Resolve the dirty Terminal Brain repo' "action cards dirty repo card"
require_in_file "$ROOT/mac-app/scripts/daily-brief.zsh" 'Terminal Brain Daily Brief' "non-launching daily brief"
require_in_file "$ROOT/mac-app/scripts/daily-brief.zsh" 'Ranked Actions' "daily brief ranked actions"
require_in_file "$ROOT/mac-app/scripts/refresh-memory.zsh" 'Terminal Brain Refresh Memory' "non-launching derived memory refresh"
require_in_file "$ROOT/mac-app/scripts/refresh-memory.zsh" 'derived summaries only' "refresh memory raw transcript guardrail"
require_in_file "$ROOT/mac-app/scripts/meeting-records.zsh" 'Terminal Brain Meeting Records' "non-launching meeting records inventory"
require_in_file "$ROOT/mac-app/scripts/meeting-records.zsh" 'does not record audio' "meeting records no-recording guardrail"
...
require_in_file "$ROOT/mac-app/scripts/use-now.zsh" 'No-Choice Path' "Use Now no-choice first value path"
require_in_file "$ROOT/mac-app/scripts/use-now.zsh" 'Do This Now' "Use Now immediate first command"
require_in_file "$ROOT/mac-app/scripts/use-now.zsh" 'make check-in' "Use Now guided check-in fallback"
require_in_file "$ROOT/mac-app/scripts/use-now.zsh" 'Save The Result' "Use Now writeback first-run instruction"
require_in_file "$ROOT/mac-app/scripts/use-now.zsh" 'Good result: one decision, one note, one artifact, or one next action' "Use Now plain-language success criteria"
...
require_in_file "$ROOT/Makefile" '^check-in:' "Check In Make target"
...
require_in_file "$ROOT/mac-app/scripts/check-in.zsh" 'Use It Immediately' "Check In immediate-use follow-up"
...
require_in_file "$ROOT/mac-app/scripts/check-entrypoints.zsh" 'make answer default question' "entrypoint covers Answer default"
...
require_in_file "$ROOT/mac-app/scripts/doctor.zsh" 'run make start' "doctor Start one-move next step"
...
require_in_file "$ROOT/mac-app/scripts/first-minute.zsh" 'make start' "first minute starts with Start"
...
require_in_file "$ROOT/mac-app/scripts/next.zsh" 'make start' "non-launching next move Start"
...
require_in_file "$ROOT/mac-app/scripts/playbook.zsh" 'make start' "playbook starts with Start"
...
require_in_file "$ROOT/mac-app/scripts/completion-audit.zsh" 'Terminal Brain Completion Audit' "non-launching completion audit"
require_in_file "$ROOT/mac-app/scripts/completion-audit.zsh" 'Prompt-To-Artifact Checklist' "completion audit checklist"
require_in_file "$ROOT/mac-app/scripts/completion-audit.zsh" 'TERMINAL_BRAIN_COMPLETION_AUDIT_SKIP_VERIFY' "completion audit MCP recursion guard"
require_in_file "$ROOT/mac-app/scripts/completion-audit.zsh" 'not marked complete until live visual review' "completion audit explicit visual blocker"
require_in_file "$ROOT/mcp-server/server.mjs" 'value-audit.zsh"\)\], \{ timeout: 120000 \}' "MCP value audit timeout headroom"
require_in_file "$ROOT/mcp-server/server.mjs" 'timeout: 120000' "MCP completion audit timeout headroom"
...
require_in_file "$ROOT/mac-app/scripts/visual-review-plan.zsh" 'Evidence To Capture' "visual review has falsifiable evidence checklist"
require_in_file "$ROOT/mac-app/scripts/visual-review-plan.zsh" 'Fail Fast Criteria' "visual review has explicit failure criteria"
require_in_file "$ROOT/mac-app/scripts/visual-review-plan.zsh" 'Pass Evidence Template' "visual review has outcome writeback template"
...
require_in_file "$ROOT/mac-app/Sources/TerminalBrain/ContentView.swift" 'Show All Surfaces' "sidebar has explicit advanced escape hatch"
require_in_file "$ROOT/mac-app/Sources/TerminalBrain/ContentView.swift" 'Reveal the full Terminal Brain surface map' "sidebar advanced escape hatch tooltip"
require_in_file "$ROOT/mac-app/Sources/TerminalBrain/Models.swift" 'operatorPathOnly' "settings remember simple operator navigation"
require_in_file "$ROOT/mac-app/Sources/TerminalBrain/SettingsView.swift" 'Simple operator navigation' "settings expose simple operator navigation"
...
require_in_file "$ROOT/mac-app/scripts/agent-prompt.zsh" 'Current One Move' "Agent Prompt carries current One Move"
require_in_file "$ROOT/mac-app/scripts/agent-prompt.zsh" 'next non-recursive move' "Agent Prompt avoids recursive delegation"
require_in_file "$ROOT/mac-app/scripts/agent-prompt.zsh" 'analysis alone is not enough' "Agent Prompt demands concrete artifact"
require_in_file "$ROOT/mac-app/scripts/agent-prompt.zsh" 'closed-app local fallback' "Agent Prompt close-loop does not require app open"
...
require_in_file "$ROOT/Makefile" '^start: use-now' "Start Make alias routes to Use Now"
...
require_in_file "$ROOT/Makefile" '^completion-audit:' "Completion Audit Make target"
...
require_in_file "$ROOT/mcp-server/server.mjs" 'terminal_brain_check_in_markdown' "Check In MCP tool"
require_in_file "$ROOT/mcp-server/server.mjs" 'terminal_brain_completion_audit_markdown' "Completion Audit MCP tool"
require_in_file "$ROOT/mcp-server/server.mjs" 'TERMINAL_BRAIN_COMPLETION_AUDIT_SKIP_VERIFY' "Completion Audit MCP light mode"
...
require_in_file "$ROOT/mcp-server/expected-tools.json" 'terminal_brain_what_now_markdown' "What Now MCP contract"
...
require_in_file "$ROOT/mcp-server/expected-tools.json" 'terminal_brain_check_in_markdown' "Check In MCP contract"
require_in_file "$ROOT/mcp-server/expected-tools.json" 'terminal_brain_completion_audit_markdown' "Completion Audit MCP contract"
require_in_file "$ROOT/mcp-server/expected-tools.json" 'terminal_brain_visual_review_plan_markdown' "Visual Review Plan MCP contract"
require_in_file "$ROOT/mcp-server/expected-tools.json" 'terminal_brain_freshness_markdown' "Freshness MCP contract"
require_in_file "$ROOT/mcp-server/expected-tools.json" 'terminal_brain_action_cards_markdown' "Action Cards MCP contract"
require_in_file "$ROOT/mcp-server/expected-tools.json" 'terminal_brain_daily_brief_markdown' "Daily Brief MCP contract"
require_in_file "$ROOT/mcp-server/expected-tools.json" 'terminal_brain_refresh_memory_markdown' "Refresh Memory MCP contract"
require_in_file "$ROOT/mcp-server/expected-tools.json" 'terminal_brain_meeting_records_markdown' "Meeting Records MCP contract"
...
require_in_file "$ROOT/AGENTS.md" 'terminal_brain_use_now_markdown' "agent Use Now instruction"
require_in_file "$ROOT/AGENTS.md" 'Ask, Decide, Remember' "agent simple native path instruction"
...
require_in_file "$ROOT/AGENTS.md" 'terminal_brain_visual_review_plan_markdown' "agent visual review plan instruction"
...
require_in_file "$ROOT/AGENTS.md" 'terminal_brain_what_now_markdown' "agent What Now instruction"
...
require_in_file "$ROOT/README.md" 'make start' "README Start command"
...
require_in_file "$ROOT/README.md" 'make completion-audit' "README Completion Audit command"
require_in_file "$ROOT/README.md" 'make design-audit' "README Design Audit command"
require_in_file "$ROOT/README.md" 'make check-in' "README Check In command"
require_in_file "$ROOT/AGENTS.md" 'terminal_brain_check_in_markdown' "agent Check In instruction"
...
require_in_file "$ROOT/README.md" 'make what-now' "README What Now command"
require_in_file "$ROOT/README.md" 'terminal_brain_value_proof_markdown' "README Value Proof MCP tool"
require_in_file "$ROOT/README.md" 'terminal_brain_visual_review_plan_markdown' "README Visual Review Plan MCP tool"
require_in_file "$ROOT/README.md" 'Simple operator navigation' "README simple operator navigation"
require_in_file "$ROOT/README.md" 'Ask, Decide, Remember' "README inline Oracle loop"
...
require_in_file "$ROOT/START-HERE.md" 'make start' "repo Start command"
require_in_file "$ROOT/START-HERE.md" 'simple operator sidebar' "Start Here simple native path"
require_in_file "$ROOT/START-HERE.md" 'Ask, Decide, Remember' "Start Here inline Oracle loop"

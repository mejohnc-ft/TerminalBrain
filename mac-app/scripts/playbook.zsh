...
echo "| I need one real thing to do | \`make start\` | One move first, then compact pull-forward context plus ask, capture, delegate, and outcome commands |"
...
echo "make bubble-up"
echo "make outcome TITLE=\"First useful loop\" OUTCOME=\"Captured, reviewed, and chose one next action.\" PROJECT=\"Terminal Brain\" NEXT=\"Run make start tomorrow.\""
echo "\`\`\`"
echo
...
echo "## Daily Cadence"
echo
echo "1. Run \`make start\` before planning."

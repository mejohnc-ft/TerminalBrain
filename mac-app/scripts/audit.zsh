...
require_evidence "$ROOT/Makefile" '^visual-review-plan:' "make visual-review-plan"
...
require_evidence "$ROOT/mac-app/scripts/use-now.zsh" 'Terminal Brain Use Now' "closed-app Use Now path"
require_evidence "$ROOT/mac-app/scripts/use-now.zsh" '## One Move' "Use Now one-move command"
require_evidence "$ROOT/mac-app/scripts/use-now.zsh" 'Ask, Capture, Delegate, Close' "Use Now closed-loop commands"
require_evidence "$ROOT/mac-app/Sources/TerminalBrain/ContentView.swift" 'selectedSection = "use-now"' "native app opens on Use Now"
...
require_evidence "$ROOT/mac-app/Sources/TerminalBrain/ContentView.swift" 'Check Blindspots' "native Radar counter-signal path"
require_evidence "$ROOT/mac-app/Sources/TerminalBrain/ContentView.swift" 'Capture as Idea' "native Blindspots tracked idea path"
require_evidence "$ROOT/mac-app/Sources/TerminalBrain/ContentView.swift" 'focusIdeaCapturePanel\(focus\)' "native Ideas direct capture lane"
...
require_evidence "$ROOT/mac-app/Sources/TerminalBrain/ContentView.swift" 'Open Use Now' "command palette can open Use Now"
...
require_evidence "$ROOT/mac-app/Sources/TerminalBrain/LocalControlServer.swift" '"/use-now/markdown"' "Use Now API artifact"
...
require_evidence "$ROOT/mac-app/Sources/TerminalBrain/AppShortcuts.swift" 'CopyUseNowIntent' "Copy Use Now shortcut"
...
require_evidence "$ROOT/mcp-server/server.mjs" 'terminal_brain_use_now_markdown' "MCP Use Now"
...
require_evidence "$ROOT/mac-app/scripts/check-entrypoints.zsh" 'use-now.zsh' "Use Now entrypoint regression"

...
- MCP tools for status, snapshot, snapshot Markdown, setup, focus, Operator Brief, focus ask, radar, sources, briefing, permissions, sync, Start Work, Oracle ask, ask-and-commit, idea capture, Oracle items, and Oracle commits.

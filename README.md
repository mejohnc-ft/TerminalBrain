...
- Proactive Briefing: `make freshness`, `make action-cards`, `make daily-brief`, `make refresh-memory`, `make meeting-records`, `terminal_brain_freshness_markdown`, `terminal_brain_action_cards_markdown`, `terminal_brain_daily_brief_markdown`, `terminal_brain_refresh_memory_markdown`, and `terminal_brain_meeting_records_markdown` turn source staleness, agent histories, local meeting records, Oracle review state, repo state, and UX blockers into ranked next actions.

...
- Now orientation: `make now`, `/now/markdown`, `terminal_brain_now_markdown`, Copy Now in the app/menu bar, and the Copy Now App Shortcut give one page with bottom line, next action, process truth, readiness, and the outcome close loop.

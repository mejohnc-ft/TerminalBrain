...
This checks repo and CI state, app build/install state and freshness, MCP syntax and tool contract, common agent config references, prompt-prone Apple Notes/Drafts bridges, process state, launchctl, and localhost API readiness.

...
- Work Block: `make work-block` and `terminal_brain_work_block_markdown` combine Bubble Up, Review Queue, and outcome writeback into one closed-app work surface.

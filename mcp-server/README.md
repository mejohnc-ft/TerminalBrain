...
Start Terminal Brain before using app-backed MCP tools. `terminal_brain_first_minute_markdown`, `terminal_brain_now_markdown`, `terminal_brain_value_now_markdown`, `terminal_brain_value_proof_markdown`,
